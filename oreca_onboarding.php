	...
	if(isset($_POST['clientboardingform'])=='clientboardingform')
	{
		...
		if($Agreementcopy !='')
		{
			...
			if(in_array($extension, $allowedExts))
			{
				...
				$agreementcopynewfilename = 'or_agrcopy_'.$accountId.'_'.date("dmyhis").'_'.rand().'.'.end($temp);
		...
		foreach ($_FILES['kyc']['tmp_name'] as $key => $value)
			 {
						...
						if(in_array($extension, $allowedExts))
						{
							...
							$kycfilename = 'or_kyc_'.$accountId.'_'.date("dmyhis").'_'.rand().'.'.end($temp);
	 ...
	 ////////////////// cancel cheque ////////////
		...
		if($cancelcheq !='')
		{
			...
			if(in_array($extension, $allowedExts))
			{
				...
				$cancelcheqnewfilename = 'or_calche_'.$accountId.'_'.date("dmyhis").'_'.rand().'.'.end($temp);
