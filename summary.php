...
<body>
  ...
  <div class="wrapper">
    ...
    <div id="content">
	  ...
	  <?php }  } ?>
    <div class="container">
	<form action="excel_grn_ledger.php" method="post">
<div class="form-row">
    <div class="form-group col-md-2">
					<select class="form-control" name="vendors_list" id="vendors_list" required oninput="setclientstype()">
    ...
    <div class="form-group col-md-2">
			<select class="form-control" name="names_list" id="names_list" required oninput="setclientsname()"></select>
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style="width: 15%;">Vendors name</th>
...
-->      <th scope="col" style="width: 10%;">Bill Number</th>
  ...
  ?>
     <tr>
        <th scope="row" style="width: 10%;"><?php echo $inc; ?></th>
        <td style="width: 15%;"><?php echo htmlspecialchars($cdata['farmers_name']); ?></td>
...
<?php */?>        <td style="width: 10%;"><?php echo htmlspecialchars($cdata['billnumber']); ?></td>
	 ...
	 <td style="width: 10%;"><a href="excel.php?id=<?php echo $cdata['id']; ?>"><i class="bi bi-download"></i><a></td>
