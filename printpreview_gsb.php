...
$itemdata = $account->getGoods_SupplyBillByID($accountId,$pid);

	   $clientType = $itemdata[0]['client_type'];
	   switch ($clientType) {
        case '1':
            $list = "modern";
            break;
...
<body>
  ...
  <tbody>
    <tr>
      ...
      <td width="50%"><strong>Client Type :</strong><?php echo $list; ?><br><strong>Client Name:</strong> <?php echo htmlspecialchars($itemdata[0]['clients_name']); ?>(<?php echo htmlspecialchars($itemdata[0]['clcode']); ?>)<br></td>
    </tr>
    <tr>
...
<br>
<button class="print-button btn btn-dark"  onClick="window.print()">Print</button>&nbsp;<button  class="print-button  btn btn-dark" ><a href="approvereject_gsb.php">Back</a></button>
        </div>
    </div>
    </div>
  </div>
