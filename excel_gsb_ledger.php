...
if(!empty($_POST))
{
	...
	$itemdata = $account->gsbsearch_ledger_excel($clientlist,$names_list);
...
$sheet->setCellValue('A2', 'Party Mobile');
...
$sheet->setCellValue('B2', $itemdata[0]['cl_mobile']);
...
header('Content-Disposition: attachment;filename="GSB_ledger.xlsx"');
