...
if(!empty($_POST))
{
	if(isset($_POST['farmerboarding'])=='farmerboarding')
	{
		...
		$cancelcheqnewfilename = $individual_farmer_data['cl_bank_cancelcheq']; 
	...
	if(!empty(array_filter($_FILES['kyc']['name'])))
	 ...
	 //////////////////end cancel cheque //////////
		$updateID  = $account->updatefarmer_Onboarding($fid,$fname,$contact,$email,$pan,$adhar,$newfilename,$kycFilesSerialized,$acctname,$acctnumber,$ifsccode,$branchname,$cancelcheqnewfilename);  // update into db
...
<div class="form-group" style="border:0px solid #999999;">
  ...
  <div class="form-group row" >
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="acctname" name="acctname" value="<?php echo $individual_farmer_data['fr_bank_acctholdername']; ?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="acctnumber" class="col-sm-3 col-form-label">Account Number:</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="acctnumber" name="acctnumber" value="<?php echo $individual_farmer_data['fr_bank_acctnumber']; ?>">
    </div>
  </div>
<div class="form-group row">
    <label for="ifsccode" class="col-sm-3 col-form-label">IFSC Code:</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="ifsccode" name="ifsccode" value="<?php echo $individual_farmer_data['fr_bank_ifsccode']; ?>">
    </div>
  </div>
<div class="form-group row">
    <label for="branchname" class="col-sm-3 col-form-label">Branch Name:</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="branchname" name="branchname" value="<?php echo $individual_farmer_data['fr_bank_branchname']; ?>">
    </div>
  </div>  <div class="form-group row">
    <label for="cancelcheq" class="col-sm-3 col-form-label">Cancel Cheque:</label>
    <div class="col-sm-9">
							<?php if(!empty($individual_farmer_data['fr_bank_cancelcheq'])) {  ?>
				<img src="images/<?php echo $individual_farmer_data['fr_bank_cancelcheq']; ?>" style="border:1px solid black"  alt="Image" height="42" width="42">
					<?php } ?>

      <input type="file" class="form-control" id="cancelcheq" name="cancelcheq" value="<?php echo $individual_farmer_data['fr_bank_cancelcheq']; ?>">
    </div>
  </div>
			</div>
