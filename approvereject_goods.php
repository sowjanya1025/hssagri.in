  ...
  <?php
	...
	?>
	  ...
	  <?php 
	    ...
	    <td><a href="printpreview.php?id=<?php echo $cdata['id']; ?>" <?php echo $pointerstate; ?>><input type="button" name="print" <?php echo $state; ?> value="print"  ></a></td>
    </tr>
	<?php }
  ?>
  </tbody>
